                    ...
                    <div class="main-content">
                      <a-radio-group class="radio-group" v-model="item.transactorType" @change="onTransactorTypeChanged(item)">
                        <a-grid :cols="3" :colGap="0" :rowGap="10">
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.SELF">发起人本人</a-radio>
                          </a-grid-item>
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.SUPERIOR">上级</a-radio>
                          </a-grid-item>
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.DEPARTMENT_LEADER">部门负责人</a-radio>
                          </a-grid-item>
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.ROLE">角色</a-radio>
                          </a-grid-item>
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.ASSIGNEE">指定成员</a-radio>
                          </a-grid-item>
                          <a-grid-item>
                            <a-radio :value="ASSIGNEE.INITIATOR_CHOICE" :disabled="haveMultiNode">发起人自选</a-radio>
                          </a-grid-item>
                        </a-grid>
                      </a-radio-group>
                    </div>
