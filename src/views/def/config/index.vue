<template>
  <div class="fd-main-box" v-loading.fullscreen="loading">
    ...
    <div class="flow-groups-area">
      <a-card class="empty-flow-box general-card" v-if="!groups || groups.length == 0">
        <a-empty />
      </a-card>
...
import { IconCheckCircle, IconDelete, IconEdit, IconPlus, IconSearch, IconStop } from "@arco-design/web-vue/es/icon";
