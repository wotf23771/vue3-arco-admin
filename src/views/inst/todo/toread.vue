<template>
        ...
        <a-card>
            ...
            <a-col :flex="1">
                ...
                <a-row>
                    <a-col :span="6">
                    <a-form-item field="procInstName" label="待阅事项">
                        <a-input v-model="queryParam.procInstName" placeholder="请输入待阅事项" allow-clear />
                    </a-form-item>
                    </a-col>
            ...
            <template #columns>
                ...
                <a-table-column title="待阅事项" data-index="procInstName" align="center" ></a-table-column>
                <a-table-column title="当前环节" data-index="taskName" align="center" width="200"></a-table-column>
                <a-table-column title="待阅人" data-index="receiverName" align="center" width="200"></a-table-column> 
                ...
                <template #cell="{ record }">
                    <a-space>
                    <a-popconfirm content="确定要办理？" @ok="handleDelete(record)">
                        <a-link :hoverable="false" >办理</a-link>
                    </a-popconfirm>
  ...
  import { pageQueryToRead } from "@/api/inst/todo";
  ...
  const loadTableData = async () => {
    try {
      loading.value = true;
      const { data, page } = await pageQueryToRead(tablePagination, queryParam);
