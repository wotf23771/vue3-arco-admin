<template>
        ...
        <a-card>
            ...
            <a-col :flex="1">
                ...
                <a-row>
                    <a-col :span="6">
                    <a-form-item field="procInstName" label="已阅事项">
                        <a-input v-model="queryParam.procInstName" placeholder="请输入已阅事项" allow-clear />
                    </a-form-item>
                    </a-col>
            ...
            <template #columns>
                ...
                <a-table-column title="已阅事项" data-index="procInstName" align="center"></a-table-column>
                <a-table-column title="已阅人" data-index="receiverName" align="center" width="200"></a-table-column> 
                <a-table-column title="接收日期" data-index="receiveDate" align="center"  width="200"></a-table-column>
                <a-table-column title="阅读时间" data-index="readDate" align="center"  width="200"></a-table-column>
  ...
  import { pageQueryHaveRead } from "@/api/inst/todo";
  ...
  const loadTableData = async () => {
    try {
      loading.value = true;
      const { data, page } = await pageQueryHaveRead(tablePagination, queryParam);
